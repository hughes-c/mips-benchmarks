...
#line 144
  Global->computestart = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 144
};
...
#line 148
  Global->computeend = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 148
};
...
#line 175
   ...
   sesc_barrier_init(&(Global->Barload));
#line 181
;
   sesc_barrier_init(&(Global->Bartree));
#line 182
;
   sesc_barrier_init(&(Global->Barcom));
#line 183
;
   sesc_barrier_init(&(Global->Baraccel));
#line 184
;
   sesc_barrier_init(&(Global->Barstart));
#line 185
;
   sesc_barrier_init(&(Global->Barpos));
#line 186
;

   sesc_lock_init(&(Global->CountLock));
#line 188
;
   sesc_lock_init(&(Global->io_lock));
#line 189
;
}
...
tab_init()
{
   ...
   {int i;for(i=0;i<MAXLOCK;i++){sesc_lock_init(&(CellLock->CL[i]));
#line 262
;}};
}
...
#line 516
  trackstart = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 516
};
    }
...
#ifdef SIMICS
#line 529
       SIMICS_ENTER_BARRIER(&(Global->Barstart), NPROC);
#line 529
#endif
#line 529
	sesc_barrier(&(Global->Barstart), NPROC);
#line 529

#line 529
#ifdef SIMICS
#line 529
       SIMICS_LEAVE_BARRIER(&(Global->Barstart));
#line 529
#endif
#line 529
};
...
#line 532
  treebuildstart = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 532
};
    }
...
#line 539
  treebuildend = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 539
};
...
#line 551
  partitionstart = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 551
};
    }
...
#line 559
  partitionend = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 559
};
...
#line 564
  forcecalcstart = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 564
};
    }
...
#line 570
  forcecalcend = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 570
};
...
#ifdef SIMICS
#line 607
       SIMICS_ENTER_BARRIER(&(Global->Barpos), NPROC);
#line 607
#endif
#line 607
	sesc_barrier(&(Global->Barpos), NPROC);
#line 607

#line 607
#ifdef SIMICS
#line 607
       SIMICS_LEAVE_BARRIER(&(Global->Barpos));
#line 607
#endif
#line 607
};
...
#line 610
  trackend = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
#line 610
};
