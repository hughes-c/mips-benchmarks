...
#ifdef SIMICS
       SIMICS_START_IGNORE();
       SIMICS_BEGIN_LOCK(&(BOX[i][j][k].boxlock));
#endif
	sesc_lock(&(BOX[i][j][k].boxlock));

#ifdef SIMICS
       SIMICS_LOCKED(&(BOX[i][j][k].boxlock));
       SIMICS_STOP_IGNORE();
#endif
#endif
};
       ...
       SIMICS_START_IGNORE();
#endif
	sesc_unlock(&(BOX[i][j][k].boxlock));

#ifdef SIMICS
       SIMICS_UNLOCK(&(BOX[i][j][k].boxlock));
       SIMICS_STOP_IGNORE();
#endif
...
#ifdef SIMICS
       SIMICS_START_IGNORE();
       SIMICS_BEGIN_LOCK(&(BOX[X_INDEX][Y_INDEX][Z_INDEX].boxlock));
#endif
	sesc_lock(&(BOX[X_INDEX][Y_INDEX][Z_INDEX].boxlock));

#ifdef SIMICS
       SIMICS_LOCKED(&(BOX[X_INDEX][Y_INDEX][Z_INDEX].boxlock));
       SIMICS_STOP_IGNORE();
#endif
#endif
};
       ...
       SIMICS_START_IGNORE();
#endif
	sesc_unlock(&(BOX[X_INDEX][Y_INDEX][Z_INDEX].boxlock));

#ifdef SIMICS
       SIMICS_UNLOCK(&(BOX[X_INDEX][Y_INDEX][Z_INDEX].boxlock));
       SIMICS_STOP_IGNORE();
#endif
