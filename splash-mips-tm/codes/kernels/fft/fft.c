...
/* POSSIBLE ENHANCEMENT:  Here is where one might reset the
  ...
  initdone = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
};
  }
...

{
  ...
  clocktime1 = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
};
  }
  ...
  clocktime2 = (sc_tp.tv_sec & 0x7ff)*1000000 + sc_tp.tv_usec;
};
